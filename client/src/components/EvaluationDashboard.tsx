        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                <th className="px-6 py-3 text-left text-gray-700 text-sm">Project Title</th>
                <th className="px-6 py-3 text-left text-gray-700 text-sm">Student Name</th>
                {userRole === 'assessor' && (
                  <th className="px-6 py-3 text-left text-gray-700 text-sm">Role</th>
                )}
                <th className="px-6 py-3 text-left text-gray-700 text-sm">Department</th>
                {userRole !== 'assessor' && (
                  <th className="px-6 py-3 text-left text-gray-700 text-sm">Avg Score</th>
                )}
                  ...
                  <tr key={project.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4">
                      <div>
                        ...
                        <p className="text-gray-500 text-sm mt-1">{project.studentId}</p>
                      </div>
                    </td>
                    <td className="px-6 py-4 text-gray-900">{project.studentName}</td>
                    {userRole === 'assessor' && (
                      <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4 text-gray-600">{project.department}</td>
                    {userRole !== 'assessor' && (
                      <td className="px-6 py-4">
                        {project.averageScore !== undefined ? (
                          <span className="text-gray-900">{project.averageScore.toFixed(1)}/100</span>
                        ) : (
